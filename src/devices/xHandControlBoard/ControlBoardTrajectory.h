...
public:
    ...
    virtual bool initTrajectory(double current_pos,
                                ...
                                double speed,
                                double acceleration,
                                std::chrono::milliseconds controller_period) = 0;
...
public:
    ...
    bool abortTrajectory(double limit) override;
    double computeTrajectory()  override;
    double computeTrajectoryStep()  override;
    TrajectoryType getTrajectoryType()  override;
};
